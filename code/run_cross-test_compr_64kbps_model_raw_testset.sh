...
##################      IA: below, I've deliberately chosen the raw test set to be decoded by the model trained on 64kbps mp3-compr features
recog_set="et_${lang}_raw_04.01.2019" #"et_${lang}_compr_64kbps_scaled0.7" # " dt_${lang}_compr_64kbps_scaled0.7"
#########
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    echo "stage 4: Cross-test: decoding a raw testset with a model trained on 64kbps mp3-compr features"
    ...
    (
        ...
        # IA: commented it because the split was already created during original decoding 
