...
#conf/train.yaml
decode_config=conf/decode_beam-sz10_batch_sz=15_ctcw-0.3_31.01.2020.yaml
#conf/decode.yaml
...
recog_set="et_${lang}_compr-24kbps" #"dt_${lang}_compr-24kbps et_${lang}_compr-24kbps"
