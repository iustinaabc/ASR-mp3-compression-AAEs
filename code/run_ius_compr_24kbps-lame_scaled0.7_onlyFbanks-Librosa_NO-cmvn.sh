...
train_set=tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn
train_dev=dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn
recog_set="dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn et_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn"
advEx_set="et_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn"
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    selected=${voxforge}/${lang}_compr_mp3_24kbps_scaled0.7_lame/extracted #### IA: from here I start to use the lame wav-mp3 decoded samples
    # Initial normalization of the data
    local/voxforge_data_prep.sh ${selected} ${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn
    local/voxforge_format_data.sh ${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn
fi
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    # steps/make_fbank_pitch.sh --cmd "$train_cmd" --nj 15 --write_utt2num_frames true \
        # data/all_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn exp/make_fbank/train_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn ${fbankdir}
...
# Note: <log-dir> defaults to <data-dir>/log, and <fbank-dir> defaults to <data-dir>/data
    ...
    make_fbank_librosa.sh --cmd "${train_cmd}" --nj 15 \
        ...
        --n_mels ${n_mels} \
        --window ${window} \
        data/all_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn \
        data/all_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/log \
        data/all_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/features
    # IA original line was: --win_length "${win_length}" \
    # I selected win_length as 512 according to Kaldi

    utils/fix_data_dir.sh data/all_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn
    ...
    remove_longshortdata.sh data/all_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn data/all_trim_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn

    # following split consider prompt duplication (but does not consider speaker overlap instead)
    local/split_tr_dt_et.sh data/all_trim_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn \
        data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn \
        data/dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn \
        data/et_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn

    rm -r data/all_trim_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn

    # compute global CMVN
    #compute-cmvn-stats scp:data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/feats.scp data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/cmvn.ark
...
#         data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/feats.scp data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/cmvn.ark exp/dump_feats/train ${feat_tr_dir}
#     dump.sh --cmd "$train_cmd" --nj 4 --do_delta ${do_delta} \
#         data/dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/feats.scp data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/cmvn.ark exp/dump_feats/dev ${feat_dt_dir}
...
dict=data/lang_1char_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/tr_${lang}_units.txt
echo "dictionary: ${dict}"
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ### Task dependent. You have to check non-linguistic symbols used in the corpus.
    echo "stage 2: Dictionary and Json Data Preparation"
    mkdir -p data/lang_1char_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/
    echo "<unk> 1" > ${dict} # <unk> must be 1, 0 will be used for "blank" in CTC
    text2token.py -s 1 -n 1 data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/text | cut -f 2- -d" " | tr " " "\n" \
    | sort | uniq | grep -v -e '^\s*$' | awk '{print $0 " " NR+1}' >> ${dict}
    wc -l ${dict}

    # make json labels
    data2json.sh --lang ${lang} --feat data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/feats.scp \
         data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn ${dict} > data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/data.json
    data2json.sh --lang ${lang} --feat data/dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/feats.scp \
         data/dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn ${dict} > data/dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/data.json
    # for rtask in ${recog_set}; do
    ...
    ##### IA: added
    data2json.sh --lang ${lang} --feat data/et_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/feats.scp \
         data/et_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn ${dict} > data/et_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/data.json
fi
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --verbose ${verbose} \
        --resume ${resume} \
        --train-json data/tr_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/data.json \
        --valid-json data/dt_${lang}_compr_24kbps_scaled0.7_ONLY_fbanks-Librosa_NO-cmvn/data.json
fi
